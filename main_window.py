...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.read_write_list_view.setGeometry(QtCore.QRect(10, 40, 390, 471))
        ...
        self.read_only_list_view.setGeometry(QtCore.QRect(410, 40, 400, 471))
        ...
        self.upload_folders_shares_button = QtWidgets.QPushButton(self.shares_tab)
        self.upload_folders_shares_button.setGeometry(QtCore.QRect(200, 520, 81, 24))
        self.upload_folders_shares_button.setObjectName("upload_folders_shares_button")
        self.upload_files_shares_button = QtWidgets.QPushButton(self.shares_tab)
        self.upload_files_shares_button.setGeometry(QtCore.QRect(94, 520, 81, 24))
        self.upload_files_shares_button.setObjectName("upload_files_shares_button")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabs.setTabText(self.tabs.indexOf(self.myfolder_tab), _translate("MainWindow", "My FileSpace"))
        ...
        self.upload_folders_shares_button.setText(_translate("MainWindow", "Upload Folders"))
        self.upload_files_shares_button.setText(_translate("MainWindow", "Upload Files"))

...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.friend_requests_list_widget.setGeometry(QtCore.QRect(280, 30, 256, 511))
        ...
        self.search_results_list.setGeometry(QtCore.QRect(550, 60, 256, 481))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.refresh_users_button = QtWidgets.QPushButton(self.friends_tab)
        self.refresh_users_button.setGeometry(QtCore.QRect(670, 30, 75, 23))
        self.refresh_users_button.setObjectName("refresh_users_button")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.refresh_users_button.setText(_translate("MainWindow", "Refresh"))
        self.refresh_users_button.setShortcut(_translate("MainWindow", "F5"))
